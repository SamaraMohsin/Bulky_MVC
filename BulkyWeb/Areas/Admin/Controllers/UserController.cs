...
namespace BulkyBookWeb.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public IActionResult RoleManagement(RoleManagementVM roleManagementVM)
        {
            ...
            {
                //a role was updated
                if(roleManagementVM.ApplicationUser.Role == SD.Role_Company) {    //agr new role jo update kr raha ha user aur wo company ha tou company bhi add krni hogi
                    applicationUser.CompanyId = roleManagementVM.ApplicationUser.CompanyId;
                }
                if(oldRole == SD.Role_Company)    // agr purana role company tha tou company delete bhi krni ha
                {
                ...
                //remove old role and assign new role to user for that we have helper method inside user Manager
